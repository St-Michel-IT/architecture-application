...
\begin{document}
    ...
    \begin{frame}
        ...
        \end{itemize}
        \centering
        \includegraphics[width=5cm]{image/engraving-of-a-monk-drawing-a-cathedral.png}
    \end{frame}

    \begin{frame}
        \frametitle{Architectures d’Applicationsa}
    ...
    \begin{frame}
        \transdissolve
        \frametitle{Pourquoi le design ou architecture logiciel~?}
        \begin{columns}
            \column{0.5\textwidth}
            ...
            \centering
            \begin{tabular}{cc}
                \includegraphics[width=6.0cm]{image/da-vinci-plans.jpg} \\
    ...
    \begin{frame}
        ...
        \bigbreak
        Trouver et implémenter une architecture logiciel doit être simple.
    ...
    \begin{frame}
        ...
        C'est un des termes les plus importants en architecture logiciel.
    ...
    \begin{frame}
        ...
        \begin{columns}
            \column{0.6\textwidth}
            Probablement hérité du jargon de l'architecture des bâtiments, le mot brique est aussi souvent utilisé en architecture logiciel.
            \bigbreak
            ...
            \bigbreak
            Quelles sont les briques en architecture logiciel~?
            \column{0.4\textwidth}
            \centering
            \includegraphics[width=4cm]{image/engraving-of-a-craftman-cutting-a-stone.png}
        \end{columns}
    \end{frame}
...
120
    ...
    \begin{frame}[fragile]
        ...
        Pouvoir controller quelle classe dépend de quelle autre est un atout majeur de cette architecture logiciel.
        \bigbreak
...
TypeError: Can't instantiate abstract class Dodo with abstract method vole
    ...
    \begin{frame}
        ...
        \bigbreak
        \centering
        \includegraphics[width=8cm]{image/tdd-vs-no-tdd.png}
    \end{frame}
    ...
    \begin{frame}
        ...
        \bigbreak
        \centering
        \includegraphics[width=6cm]{image/the-clean-architecture.png}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \column{0.5\textwidth}
            Autrement dit, l'univers des tests est infini, on n'a jamais la certitude de sufficient tester.
            \bigbreak
            Même le coverage est une mauvaise mesure.
            \column{0.5\textwidth}
            \centering
            \includegraphics[width=5cm]{image/monk-looking-the-deepness-of-the-stars-in-the-night-sky.png}
        \end{columns}
    \end{frame}


    \section{Les outils de mesure}

    \begin{frame}
        \transdissolve
        \frametitle{Les mesures du couplage}
        \framesubtitle{L'\textquote{abstractness} $A$\cref{fundsofsoftarch}}
        L'\textquote{abstractness} est une mesure de l'abstraction par rapport aux implémentations concrètes.
    ...
    \begin{frame}
        ...
        \bigbreak
        \centering
        \includegraphics[width=5cm]{image/afferent-coupling.drawio.png}
        \bigbreak
        \flushleft
        Ici $Ca$ est 3.
    ...
    \begin{frame}
        ...
        \bigbreak
        \centering
        \includegraphics[width=5cm]{image/efferent-coupling.drawio.png}
        \bigbreak
        \flushleft
        Ici $Ce$ est 3.
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \column{0.5\textwidth}
            \centering
            \includegraphics[width=5cm]{image/distance-from-main-sequence.png}
        \end{columns}
        \bigbreak
        \flushleft
    ...
    \begin{frame}
        \transdissolve
        \frametitle{Les mesures du couplage}
        \framesubtitle{Exercice de 15 minutes}
        Calculer les valeurs de $Ca$, $Ce$, $A$, $I$ et $D$ pour les chaque classe du source \url{}.
    \end{frame}
