...
TypeError: Can't instantiate abstract class Dodo with abstract method vole
    ...
    \begin{frame}
        ...
        '\textquote{abstractness}  une mesure de l'abstraction par rapport aux implémentations concrètes.
...
$ module_coupling_metrics data_management.py
        ...
        \begin{columns}
            \column{0.5\textwidth}
            \centering
            \includegraphics[width=5cm]{image/data-management-metrics-table.png}
            \column{0.5\textwidth}
            \centering
            \includegraphics[width=5cm]{image/data-management-disance-chart.png}
        \end{columns}

        Attention à bien comprendre ces métriques et comment les interpréter.
        \lstinline{module_coupling_metrics} est ne calcule le couplage qu'entre modules.
        \bigbreak
    \end{frame}
